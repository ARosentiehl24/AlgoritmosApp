package com.unimagdalena.android.app.algoritmosapp.view.custom.particleview;
...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        Typeface Rocko = Typeface.createFromAsset(getContext().getAssets(), "fonts/Rocko.ttf");

        mParticleTextPaint.setTypeface(Rocko);
        mHostTextPaint.setTypeface(Rocko);
        mCirclePaint.setTypeface(Rocko);
        mHostBgPaint.setTypeface(Rocko);
    }
